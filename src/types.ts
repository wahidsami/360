...
export const ROLE_PERMISSIONS: Record<Role, Permission[]> = {
  ...
  [Role.OPS]: [Permission.VIEW_DASHBOARD, Permission.MANAGE_CLIENTS, Permission.MANAGE_PROJECTS, Permission.VIEW_CLIENTS, Permission.MANAGE_TASKS, Permission.MANAGE_TEAM, Permission.MANAGE_WORKSPACE_TEMPLATES, Permission.ASSIGN_WORKSPACE_TEMPLATES],
  [Role.PM]: [Permission.VIEW_DASHBOARD, Permission.MANAGE_PROJECTS, Permission.VIEW_CLIENTS, Permission.MANAGE_TASKS, Permission.MANAGE_TEAM, Permission.CREATE_PROJECT_REPORTS, Permission.EDIT_PROJECT_REPORTS, Permission.EDIT_PROJECT_REPORT_ENTRIES, Permission.GENERATE_PROJECT_REPORT_EXPORTS, Permission.PUBLISH_PROJECT_REPORTS],
  ...
  [Role.FINANCE]: [Permission.VIEW_DASHBOARD, Permission.VIEW_CLIENTS],
